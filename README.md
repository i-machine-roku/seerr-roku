...
3. **Save credentials on this device:** Checked by default. Leave it checked to skip re-entering your server URL and username next time you launch the app; uncheck it if this is a shared or borrowed Roku and you'd rather nothing survive after you close the app.

The app securely stores your server URL, username, and session token locally on your Roku's registry and connects directly to your server. Your password is never stored. If "Save credentials on this device" is unchecked, everything above is forgotten as soon as you close the app instead of surviving to your next launch.
